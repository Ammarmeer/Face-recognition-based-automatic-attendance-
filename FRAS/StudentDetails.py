...
class student_details:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","SE","IT","CS","DS","AI")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","SE","Formal Methods","Topics in SE","NLP","Quality Engineering","SE Economics","Arabic","Islamiyat","English","Linear Algebra","Discrete Structures","DSA","Database","Software Construction","ToA","Info Security","Web")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Semester","Semester-8")
        year_combo.current(0)
        ...
        #             messagebox.ERROR(res,parent=self.s_wind)
        #         if(name.isalpha()):
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="select Department" or self.var_std_name.get()==""or self.var_std_id.get()=="":
            ...
            try:
                ...
                for x in myResutl:
                    id+=1
                my_cursor.execute("update add_student set Department=%s,Course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll_No=%s,Gender=%s,DOB=%s,Email=%s,Mobile_No=%s,Address=%s,Teacher_Name=%s,PhotoSample=%s where Student_ID=%s",(
                            self.var_dep.get(),
                            self.var_course.get(),
                            self.var_year.get(),
                            self.var_semester.get(),
