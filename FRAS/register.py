...
class Register:
    def __init__(self,root):
        ...
        adminVerify =lb1= Label(frame,text="Admin Verification:",font=("times new roman",15,"bold"),fg="#002B53",bg="#F2F2F2")
        adminVerify.place(x=530,y=490)

        #entry2 
        self.txtpwd=ttk.Entry(frame,textvariable=self.var_admin,show="*",font=("times new roman",15,"bold"))
        self.txtpwd.place(x=533,y=520,width=270)
                ...
                try:
                    ...
                    if row!=None:
                        ...
                        if veri=="SeAdmin@8989":
                            ...
                            messagebox.showerror("Error","Admin not verified! Wrong password")
